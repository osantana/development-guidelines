...
We appreciate simplicity. Simple does not mean simplistic. It's hard to
achieve simplicity because it demands a lot of thinking about the
problems and solutions.

=== Pragmatism

We are pragmatic about our choices. We will never adopt a solution
without a strong rationale about the decision.

=== Quality

Quality vs fast-delivery is not a dilemma. We use agile practices to
handle this kind of situations.

We cut solution scope, make partial delivery with high quality or try to
design an alternative solution that enable an easy refactoring in the
future.

In fact we cannot neglect quality but we try hard to deliver on time
because we are a business oriented team.

=== Craftsmanship

We believe strongly in the
http://manifesto.softwarecraftsmanship.org[Software Craftsmanship]
movement and in their manifesto.
